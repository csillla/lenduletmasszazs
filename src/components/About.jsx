            ...
            <div className={styles.gridMainAb} ref={gridRef}>
                <div className={styles.firstBoxWrapper}>
                    <BoxIntro className={styles.firstBox}
                            ...
                            text="Kezdésnek örülök, hogy úgy döntöttél teszel még egy lépést a fájdalommentes és egészségesebb életmód felé. Minden tőlem telhetőt megfogok tenni, hogy megoldjuk a gondjaidat." 
                    ></BoxIntro>
                </div>
                <div className={styles.secondBoxWrapper}>
                    <BoxIntro className={styles.secondBox} ref={phase2Ref}
                        ...
                        text="Jelenlegi tudásom bázisát a gyógy- és sport masszőri képesítésem adja, mely szilárd alapokat jelent anatómiai ismeretek terén, azóta folyamatos gyakorlati tapasztalatok megszerzése mellett részt vettem számtalan különböző masszázs technika tanfolyamon." 
                    ></BoxIntro>
                </div>
                <div className={styles.thirdBoxWrapper}>
                    <BoxIntro className={styles.thirdBox} ref={phase3Ref}
                        ...
                        text="Nálam a masszázs probléma és  megoldás fókuszú, mely során az egyes tünetekből kiindulva haladunk a gyökérproblémák felderítéséig, így egy folyamat során elérve hosszú távú eredményeket." 
                    ></BoxIntro>
                </div>
